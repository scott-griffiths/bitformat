...
If you need to modify the data after creation there is also a :class:`MutableBits` class, but in practice most tasks can use the more efficient :class:`Bits` so it should be preferred if the extra capabilities are not needed.
