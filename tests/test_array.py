...
class TestArrayOperations:
    ...
    #     b = a | '0b10000000'
    #     assert a.to_list() == [-4,  2.5, -9,  0.25]
    #     assert b.to_list() == [-4, -2.5, -9, -0.25]
